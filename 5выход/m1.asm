...
На этом работа двухмодульной программы завершается.
...
отсутствовать (см. более подробно об этом в pdf-документе).
При проверке числа Х рекомендуется использовать 
...
битового представления проверяемого числа Х  с разными состояниями
данной маски (командами cmp и sub для сравнения с маской - не пользоваться!).  
...
Использовать:
пакетный файл prompt1.bat для запуска окна командной строки. 
